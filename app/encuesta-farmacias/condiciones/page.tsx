...
export const metadata: Metadata = {
  ...
  description:
    "Condiciones de participación en el estudio sobre retos de la farmacia para el futuro.",
};
      ...
      <main className="mx-auto max-w-3xl px-4 pb-16 pt-24 sm:px-6 sm:pt-28 lg:px-8">
        <article className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-10">
          <p className="mb-4 rounded-xl bg-amber-50 px-4 py-3 text-sm text-amber-900">
            Documento provisional. Debe ser revisado antes del lanzamiento público.
          </p>
          <h1 className="text-2xl font-bold text-[#1A1A1A] sm:text-3xl">
            Condiciones de participación en el estudio
          </h1>
          <p className="mt-2 text-sm text-gray-500">
            Estudio sobre los retos actuales de la farmacia para el futuro.
          </p>
          ...
          <div className="prose prose-sm mt-8 max-w-none space-y-6 text-gray-700">
            ...
            <section>
              ...
              <p>
                ...
                considerarán automáticamente aptas para el bono.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                corresponder a una farmacia real. FarmaFácil podrá contactar para
                verificar la vinculación del participante con la farmacia indicada.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-[#1A1A1A]">5. Bono regalo</h2>
              <p>
            ...
            <section>
              ...
              <p>
                ...
                hasta 10 días laborables desde la recepción, sin perjuicio de ampliaciones por
            ...
            <section>
              ...
              <p>
                ...
                automático al bono por el solo hecho de enviar el formulario.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                presupuesto de bonos regalo o por decisión del organizador, sin perjuicio del
